		...
		for(Configuration conf2:solutions)
			{
				...
				System.out.println("\n*******Configuration..."+i++ +"********");
				////////??????? next line is changed because the actual implementation does not contain configuration.getstates.
				//for (Entry<String, Vector<String>> entry : ((Map<String, Vector<String>>) conf2.getFeatureStates()).entrySet()) 
